...
<div class="col-lg-12">
    ...
    <div class="card">
        <div class="row p-2 m-0">
            <form class="needs-validation" novalidate action="student" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group files">
                    <label>Upload Your File </label>
                    <input name="student_file" type="file" class="form-control" multiple="">
                </div>
